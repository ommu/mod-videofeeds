 ...
 * --------------------------------------------------------------------------------------
 *
 * This is the model class for table "ommu_video_view_detail".
 *
 * The followings are the available columns in table 'ommu_video_view_detail':
 * @property string $id
 ...
 * @property VideoViewDetail $view
 */
class VideoViewDetail extends CActiveRecord
{
	use GridViewTrait;
	 ...
	 * @return VideoViewDetail the static model class
	 */
	...
	public function relations()
	{
		...
		return array(
			'view' => array(self::BELONGS_TO, 'VideoViews', 'view_id'),
		);
	}
	...
	public function search()
	{
		...
		if(!Yii::app()->getRequest()->getParam('VideoViewDetail_sort'))
